          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <li class="nav-item">
               ...
               <div class="collapse" id="ui-basic">
                 <ul class="nav flex-column sub-menu">
                   <li class="nav-item"> <a class="nav-link" href="../../pages/tables/basic-table.html">Tabel Percetakan</a></li>
                   <li class="nav-item"> <a class="nav-link" href="../../pages/tables/basic-table pembobotan.html">Pembobotan Kriteria</a></li>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            @endforeach
                        ...
                        <tr>
                          <td> 2 </td>
                          <td> Abata Printing Cilacap </td>
                          <td> Jl. Sulawesi Gunungsimping, Cilacap Tengah</td>
                          </td>
                          <td>
                          <div class="progress">
                        ...
                        <tr>
                          <td> 3 </td>
                          <td> AanCr Sablon & Percetakan Cilacap</td>
                          <td> Jl.Nyamplung, Tritih Kulon, Cilacap Utara </td>
                          </td>
                          <td>
                          <div class="progress">
                        ...
                        <tr>
                          <td> 4 </td>
                          <td> Percetakan Aksara </td>
                          <td> Jl. Majapahit Raya, Tegalkamulyan, Cilacap Selatan </td>
                          </td>
                          <td>
                          <div class="progress">
                            <div class="progress-bar bg-success" role="progressbar" style="width: 80%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        ...
                        <tr>
                          <td> 5 </td>
                          <td> Josh Advertising </td>
                          <td> Jl. Gatot Subroto, Sidanegara, Cilacap Tengah </td>
                          </td>
                          <td>
                          <div class="progress">
                            <div class="progress-bar bg-success" role="progressbar" style="width: 80%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        ...
                        <tr>
                          <td> 6 </td>
                          <td> Mastercom Group </td>
                          <td> Jl. Kinibalu, Sidanegara, Cilacap Tengah</td>
                          </td>
                          <td>
                          <div class="progress">
                            <div class="progress-bar bg-success" role="progressbar" style="width: 80%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        ...
                        <tr>
                          <td> 7 </td>
                          <td> New Compress </td>
                          <td> Jl. Damar, Tritih Kulon, Cilacap Utara</td>
                          </td>
                          <td>
                          <div class="progress">
                            <div class="progress-bar bg-success" role="progressbar" style="width: 80%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
