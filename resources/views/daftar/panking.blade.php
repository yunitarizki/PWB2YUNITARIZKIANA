    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="dashboard"><img src="assets/images/logo2.png" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="dashboard"><img src="assets/images/logo2.png" alt="logo" /></a>
        </div>
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
<h2>Pembobotan Kriteria</h2>
<br>
<a href="/tambahbobot" class="btn btn-success">Tambah +</a>
<br><br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                  ...
                  <td>
                    <a href="/tampilkanbobot/{{$item->id}}" class="btn btn-warning">Ubah </a>
                    <a href="/deletebobot/{{$item->id}}" class="btn btn-danger">Hapus</a>
                  </td>
                </tr>
            @endforeach
        </tbody>
