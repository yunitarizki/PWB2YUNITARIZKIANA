...
<h2 class="text-center mb-4">UBAH DATA PEMBOBOTAN</h2>
 <br><br>
...
<div class="card">
 ...
 <form action="/updatebobot/{{$data->id}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label">Kriteria</label>
      <input type="taxt" name="kriteria" class="form-control" value="{{$data->kriteria}}">
    ...
    {{-- <div class="mb-3">
        ...
        <input type="text" name="reting" class="form-control">
      </div> --}}
