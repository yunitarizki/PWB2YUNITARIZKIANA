...
{{-- @section('konten') --}}
  ...
  <h1 class="text-center mb-4">UBAH DAFTAR PERCETAKAN</h1>
 <br><br>
...
<div class="card">
 ...
 <form action="/updatedata/{{$data->id}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label">Nama Percetakan</label>
      <input type="text" name="nama_percetakan" class="form-control" value="{{$data->nama_percetakan}}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Reting</label>
        <input type="text" name="reting" class="form-control" value="{{$data->reting}}">
      </div>
...
{{-- <h2 class="text-center mb-4">TAMBAH DAFTAR PERCETAKAN</h2>
<br><br>
<div class="row justify-content-center" >
   <div class="col-8">
<div class="card">
...
<form action="" method="POST" enctype="multipart/form-data">
   ...
   <div class="mb-3">
     <label for="exampleInputEmail1" class="form-label">Nama Percetakan</label>
     <input type="taxt" name="nama_percetakan" class="form-control" value="{{$data->nama_percetakan}}">
   </div>
   <div class="mb-3">
     <label for="exampleInputPassword1" class="form-label">Alamat</label>
     <input type="text" name="alamat" class="form-control" value="{{$data->alamat}}">
