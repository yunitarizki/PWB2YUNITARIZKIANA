...
<h2 class="text-center mb-4">TAMBAH PEMBOBOTAN KATEGORI</h2>
 <br><br>
<div class="row justify-content-center" >
    <div class="col-8">
<div class="card">
    <div class="card-body">
 <form action="/insertbobot" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label">Kriteria</label>
      <input type="taxt" name="kriteria" class="form-control">
